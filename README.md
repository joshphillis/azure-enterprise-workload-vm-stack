...
data "terraform_remote_state" "landing_zone" { backend = "azurerm" config = { resource_group_name = var.lz_state_rg storage_account_name = var.lz_state_sa container_name = var.lz_state_container key = var.lz_state_key } }
